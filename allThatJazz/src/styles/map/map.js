...
function initMap() {
    let icons = {
        location: './images/icons/marker_point.svg'
    };
...
function eventsLoader() {
    let eventBtn = document.querySelector('.js-map__events'),
        eventContainer = document.querySelector('.js-events'),
        eventsHeader = document.querySelector('.js-events__header'),
